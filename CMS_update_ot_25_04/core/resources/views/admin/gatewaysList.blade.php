    ...
    <div class="col-md-12">
        <div class="tile-main">
            ...
            <div class="tile">
                ...
                @endif
                @if($gateways_list[3]->id)
                <div class="col-md-6 float-left mt-4">
                    <div class="tile">
                        <div style="font-size:15pt;text-transform:uppercase;font-weight:bold;margin-bottom:-7px;">
                            {{ @$gateways_list[3]->name }}
                        </div>
                        <hr>
                        <form id="gateway_form_3" method="post" action="#" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="tile-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <!---
                                        <div class="form-group">
                                            <input class="form-control" type="text" id="gateway_name" name="gateway_name" value="{{ @$gateways_list[3]->name }}"
                                                placeholder="Краткое название"
                                            >
                                            <span class="help-text-name text-danger"></span>
                                        </div>
                                        --->
                                        <div class="form-group">
                                            <input class="form-control" type="text" id="fullname" name="fullname" value="{{ @$gateways_list[3]->fullname }}"
                                                placeholder="Полное название"
                                            >
                                            <span class="help-text-name text-danger"></span>
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" type="text" id="description" name="description" value="{{ @$gateways_list[3]->description }}"
                                                placeholder="Описание платежа"
                                            >
                                            <span class="help-text-url text-danger"></span>
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" type="text" id="theme_code" name="theme_code" value="{{ @$gateways_list[3]->theme_code }}"
                                        ...
                                        <div class="col-md-12 p-0">
                                            <div class="form-group col-md-4 float-left p-0 pl-0 pr-1">
                                                <label class="control-label"><b>Qiwi кошелёк</b></label>
                                                <input class="form-control" type="text" id="bill_id" name="bill_id" value="{{ @$gateways_list[3]->bill_id }}"
                                                    placeholder="89998887777"
                                                >
                                                <span class="help-text-apikey text-danger"></span>
                                            </div>
                                            <div class="form-group col-md-4 float-left p-0 pl-0 pr-1">
                                                <label class="control-label"><b>Публичный ключ</b></label>
                                                <input class="form-control" type="text" id="key_public" name="key_public" value="{{ @$gateways_list[3]->key_public }}"
                                                    placeholder="Публичный ключ #1"
                                                >
                                                <span class="help-text-apikey text-danger"></span>
                                            </div>
                                            <div class="form-group col-md-4 float-left p-0 pl-1 pr-0">
                                                <label class="control-label"><b>Секретный ключ</b></label>
                                                <input class="form-control" type="text" id="key_secret" name="key_secret" value="{{ @$gateways_list[3]->key_secret }}"
                                                    placeholder="Секретный ключ #2"
                                                >
                                                <span class="help-text-apiusr text-danger"></span>
                                            </div>
                                            <small>В настройках кассы QIWI P2P укажите ссылку на обработчик https://{{ $_SERVER['SERVER_NAME'] }}/payments/qiwi</small>
                                        </div>
                                        ...
                                        <!-- <div class="form-group">
                                             <input name="status"
                                                ...
                                                data-off="Выключен"
                                                data-on="Включен"
                                                data-width="100%" type="hidden" value="1"
                                                {{ @$gateways_list[3]->status == "1" ? 'checked' : '' }}
                                            />
                                        </div> -->
                        ...
                        <div class="tile-footer">
                            <button type="button" onclick="gatewaySaver(this);" value="3" class="btn btn-outline-primary col-md-12">
                                Сохранить
                            </button>
                        </div>
                    </div>
