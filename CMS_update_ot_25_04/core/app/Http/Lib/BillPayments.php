...
use App\Http\Lib\Curl\Curl;
use App\Http\Lib\BillPaymentsException;
// use Exception;
// use ErrorException;
use DateTime;
...
if (false === defined('CLIENT_NAME')) {
     ...
     * @const string
     */
    define('CLIENT_NAME', 'Eduard-VRbjYzBNwM');
...
class BillPayments
{
    ...
    public function createPaymentForm(array $params)
    {
        ...
        $params['customFields']['themeCode']        = CLIENT_NAME;
    ...
    protected function requestBuilder($uri, $method=self::GET, array $body=[])
    {
        ...
        default:
            ...
            return "#5_Not supported method ".@$method;
        }
        ...
        if (true === $this->internalCurl->error) {
            ...
            // );
            // return "#4_Error code: ".@$this->internalCurl->error_code." - Error message: ".@$this->internalCurl;
            print_r(@$this->internalCurl);
        }
        ...
        if (false === empty($this->internalCurl->response)) {
            ...
            if (null === $json) {
                ...
                return "#3_Error code: ".@$this->internalCurl->error_code." - Error message: ".@$this->internalCurl->error_message;
            }
            ...
            if (true === isset($json['errorCode'])) {
                if (true === isset($json['description'])) {
                    ...
                    return "#2_Error code: ".@$this->internalCurl->error_code." - Error message: ".@$this->internalCurl->error_message;
                }

                // throw new BillPaymentsException(clone $this->internalCurl, $json['errorCode']);
                return "#1_Error code: ".@$json['errorCode']." - Error message: ".@$json['description'];
            }
